...
constexpr long OFF_INPUT_SYSTEM = 0x175a6c0; //[Miscellaneous] InputSystem
...
constexpr long OFF_ABS_ORIGIN = 0x0004;                     //[DataMap.C_BaseEntity]->m_vecAbsOrigin
...
constexpr long OFF_WEAPON_CURRENT_ZOOM_FOV = 0x00b8 + 0x00b8;          //m_playerData + m_curZoomFOV
constexpr long OFF_WEAPON_TARGET_ZOOM_FOV = 0x00bc + 0x00bc;           //m_playerData + m_targetZoomFOV
constexpr long OFF_WEAPON_DISCARDED = 0x1579;                 //[RecvTable.DT_WeaponX]->m_discarded
constexpr long OFF_WEAPON_AMMO = 0x1534;                 //[RecvTable.DT_WeaponX]m_ammoInClip
